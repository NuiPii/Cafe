    ...
    if (isset($_GET['order_id'])) {
        ...
        if (mysqli_num_rows($result_order) == 1) {
            ...
            <div class="receipt">
                ...
                <p><strong>เลขบัญชี: 123-456-789</strong></p>
                <p><strong>ชื่อบัญชี: คาเฟ่ เอ-พลัส (Cafe A-plus)</strong></p>

                <div class="qr-code">
                    <h3>คิวอาร์โค้ดสำหรับการชำระเงิน</h3>
                    <img src="https://upload.wikimedia.org/wikipedia/commons/d/d0/QR_code_for_mobile_English_Wikipedia.svg" alt="QR Code" style="max-width: 200px;">
                </div>
            </div>
            <div class="footer">
